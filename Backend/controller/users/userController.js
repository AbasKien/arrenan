        ...
        userModel.findByEmail(email, async (err, users) => {
            ...
            try {
                ...
                userModel.create({ name, email, password: hashedPassword, verification_token: verificationToken }, (err, result) => {
                   ...
                   // Generate the verification URL using a template literal
...
const mailOptions = {
    ...
    text: `Please verify your email by clicking the link: ${verificationUrl}` // Fixed template literal for dynamic content
};
                    ...
                    const transporter = nodemailer.createTransport({
                        ...
                        auth: {
                            ...
                            pass: 'nlxe macn xwbi xddn' // App-specific password if 2FA is enabled
                        }
                    });
